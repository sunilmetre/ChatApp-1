    ...
    <>
      <div className="flex justify-center items-center h-screen bg-gray-800">
        <form
          ...
          className="border border-gray-400 px-6 py-2 rounded-md w-96 space-y-3"
        >
          ...
          <br />
          {/* Fullname */}
          <label className="flex items-center gap-2 bg-gray-800 text-white border border-gray-700 rounded-md">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 16 16"
              fill="currentColor"
              className="h-4 w-4 opacity-70 ml-3"
            >
              <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6ZM12.735 14c.618 0 1.093-.561.872-1.139a6.002 6.002 0 0 0-11.215 0c-.22.578.254 1.139.872 1.139h9.47Z" />
            </svg>
            <input
              type="text"
              className="grow bg-gray-800 text-white py-3 rounded-md outline-none"
